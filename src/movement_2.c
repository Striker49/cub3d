...
void	move(t_data *data, int dir)
{
	...
	if (dir == NORTH && data->map[(int)(data->player.y
			+ (sin(data->player_angle) * SPEED))][(int)data->player.x]
		!= '1' && data->map[(int)(data->player.y)][(int)(data->player.x
		+ (cos(data->player_angle) * SPEED))] != '1')
		move_1(data, dir);
	else if (dir == SOUTH && data->map[(int)(data->player.y
			+ (sin(data->player_angle) * -1))]
		[(int)data->player.x] != '1' && data->map[(int)(data->player.y)]
		[(int)(data->player.x + (cos(data->player_angle) * -SPEED))] != '1')
		move_2(data, dir);
	else if (dir == WEST && data->map[(int)(data->player.y
			+ (cos(data->player_angle) * -SPEED))][(int)data->player.x]
		!= '1' && data->map[(int)(data->player.y)][(int)(data->player.x
		+ (sin(data->player_angle) * SPEED))] != '1')
		move_3(data, dir);
	else if (dir == EAST && data->map[(int)(data->player.y
			+ (cos(data->player_angle) * SPEED))][(int)data->player.x]
		!= '1' && data->map[(int)(data->player.y)][(int)(data->player.x
		+ (sin(data->player_angle) * -SPEED))] != '1')
		move_4(data, dir);
...
{
	(void)dir;
	if (data->map[(int)(data->player.y + (sin(data->player_angle) * SPEED))]
		[(int)data->player.x] != '1')
